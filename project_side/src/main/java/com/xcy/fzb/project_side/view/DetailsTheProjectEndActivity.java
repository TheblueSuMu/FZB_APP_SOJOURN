...
import com.xcy.fzb.project_side.api.DynamicLineChartManager;
...
//TODO 项目详情
public class DetailsTheProjectEndActivity extends AppCompatActivity implements View.OnClickListener {

    ImageView details_the_project_end_img;
    ImageView details_the_project_end_return;
    ...
    RadioButton details_the_project_end_rb12;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_details_the_project_end);
        initView();
    }
    ...
    private void initView() {
        ...
        details_the_project_end_rb12 = findViewById(R.id.details_the_project_end_rb12);
        ...
        details_the_project_end_rb12.setOnClickListener(this);
...
//                TODO 项目定位
            case R.id.details_the_project_end_rl2:
                ...
                break;
//                TODO 时间选择1
            case R.id.details_the_project_end_time1:
//                intent = new Intent();
//                startActivity(intent);
                break;
//                TODO 时间选择2
            case R.id.details_the_project_end_time2:
//                intent = new Intent();
//                startActivity(intent);
                break;
//                TODO 时间选择3
            case R.id.details_the_project_end_time3:
//                intent = new Intent();
//                startActivity(intent);
                break;
//                TODO 时间选择4
            case R.id.details_the_project_end_time4:
//                intent = new Intent();
//                startActivity(intent);
                break;
//                TODO 报备审核
            case R.id.details_the_project_end_tv4:
//                intent = new Intent();
//                startActivity(intent);
                break;
//                TODO 报备成功
            case R.id.details_the_project_end_tv5:
//                intent = new Intent();
//                startActivity(intent);
                break;
//                TODO 到访
            case R.id.details_the_project_end_tv6:
//                intent = new Intent();
//                startActivity(intent);
                break;
//                TODO 登岛
            case R.id.details_the_project_end_tv8:
//                intent = new Intent();
//                startActivity(intent);
                break;
//                TODO 认筹
            case R.id.details_the_project_end_tv9:
//                intent = new Intent();
//                startActivity(intent);
                break;
//                TODO 成交
            case R.id.details_the_project_end_tv10:
//                intent = new Intent();
//                startActivity(intent);
                break;
//                TODO 失效
            case R.id.details_the_project_end_tv11:
//                intent = new Intent();
//                startActivity(intent);
                break;
//                TODO 应收
            case R.id.details_the_project_end_tv12:
//                intent = new Intent();
//                startActivity(intent);
                break;
//                TODO 已结
            case R.id.details_the_project_end_tv13:
//                intent = new Intent();
//                startActivity(intent);
                break;
//                TODO 待结
            case R.id.details_the_project_end_tv14:
//                intent = new Intent();
//                startActivity(intent);
                break;
//                TODO 未结
            case R.id.details_the_project_end_tv15:
//                intent = new Intent();
//                startActivity(intent);
                break;
...
//                        TODO 成交
            case R.id.details_the_project_end_rb11:
                ...
                break;
//                    TODO 全部
            case R.id.details_the_project_end_rb12:
