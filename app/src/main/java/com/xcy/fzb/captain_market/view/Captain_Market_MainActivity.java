        ...
        img_backup.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (FinalContents.getCityID().equals(FinalContents.getOldCityId())) {
                    ...
                    Toast.makeText(Captain_Market_MainActivity.this, "该城市不是您的主营城市，请切换到您的主营城市后再报备客户", Toast.LENGTH_SHORT).show();
                }
            }
        });
        click();
...
//                            Toast.makeText(LoginActivity.this,"当前版本已是最新版本",Toast.LENGTH_SHORT).show();
                            ...
                            AlertDialog.Builder builder1 = new AlertDialog.Builder(Captain_Market_MainActivity.this);
    ...
    protected void showDownloadDialog() {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(Captain_Market_MainActivity.this);
        builder.setTitle("下载中");
        View view = LayoutInflater.from(Captain_Market_MainActivity.this).inflate(R.layout.dialog_progress, null);
...
//      安装完成后，启动app（源码中少了这句话）
        ...
        Captain_Market_MainActivity.this.startActivity(intent);
    }
}
