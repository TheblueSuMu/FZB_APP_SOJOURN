...
//                            Toast.makeText(LoginActivity.this,"当前版本已是最新版本",Toast.LENGTH_SHORT).show();
                            ...
                            AlertDialog.Builder builder1 = new AlertDialog.Builder(Shopping_Guide_MainActivity.this);
    ...
    protected void showDownloadDialog() {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(Shopping_Guide_MainActivity.this);
        builder.setTitle("下载中");
        View view = LayoutInflater.from(Shopping_Guide_MainActivity.this).inflate(R.layout.dialog_progress, null);
...
//      安装完成后，启动app（源码中少了这句话）
        ...
        Shopping_Guide_MainActivity.this.startActivity(intent);
    }
}
