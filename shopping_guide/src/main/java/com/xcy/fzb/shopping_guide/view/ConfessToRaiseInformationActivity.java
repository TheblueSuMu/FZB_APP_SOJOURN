...
import com.xcy.fzb.shopping_guide.modle.ConfessBean;
...
//                TODO 解析bean类
                url = FinalContents.getBaseUrl()+"/fangfang/app/v1/nodeUpdate/earnestMoneySave?id="+""+"&preparationId=" + FinalContents.getPreparationId() + "&customerId=" + FinalContents.getCustomerID() + "&projectId=" + FinalContents.getProjectID() + "&fullName=" + s + "&phone=" + s1 + "&idNumber=" + s2 + "&intentionPier=" + s3 + "&apartment=" + s8 + "&intentionalArea=" + s4 + "&recognizeTime=" + s7 + "&relation=" + s5 + "&userId=" + FinalContents.getUserID();
                Log.i("数据","preparationId="+FinalContents.getPreparationId());
                Log.i("数据","&customerId=" + FinalContents.getCustomerID());
                Log.i("数据","&projectId=" + FinalContents.getProjectID());
