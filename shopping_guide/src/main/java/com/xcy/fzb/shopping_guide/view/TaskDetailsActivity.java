...
import com.xcy.fzb.shopping_guide.persente.AppBarStateChangeListener;
...
public class TaskDetailsActivity extends AllActivity{
    ...
    TextView task_details_constraintlayout_up;
    ...
    private void initView(){
        ...
        task_details_constraintlayout_up = findViewById(R.id.task_details_constraintlayout_up);
        ...
        task_details_constraintlayout_up.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if (task_details_constraintlayout_up.getText().toString().equals("收起")) {
                    task_details_constraintlayout_up.setText("显示");
                    task_details_constraintlayout_layout.setVisibility(View.GONE);
                }else if (task_details_constraintlayout_up.getText().toString().equals("显示")) {
                    task_details_constraintlayout_up.setText("收起");
        ...
        userMessage.subscribeOn(Schedulers.io())
                ...
                .subscribe(new Observer<TaskDetailsBean>() {
                    ...
                    public void onNext(TaskDetailsBean taskDetailsBean) {
                        if (taskDetailsBean.getData().getRouteTimeInfo().getTaskStatus().equals("50")) {
                        ...
                        } else if (taskDetailsBean.getData().getRouteTimeInfo().getTaskStatus().equals("60")) {
                        ...
                        if (taskDetailsBean.getData().getProjectSpecialInfo().size() == 0) {
                            task_details_constraintlayout_layout.setVisibility(View.GONE);
                            task_details_constraintlayout_up.setText("无");
                        }else {
                            task_details_constraintlayout_layout.setVisibility(View.VISIBLE);
