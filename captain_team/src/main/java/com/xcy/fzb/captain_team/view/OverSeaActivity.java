...
import com.xcy.fzb.captain_team.adapter.IssueAdapter;
import com.xcy.fzb.captain_team.adapter.OverseaCityAdapter;
import com.xcy.fzb.captain_team.adapter.RecyclerAdapter;
import com.xcy.fzb.captain_team.api.FinalContents;
import com.xcy.fzb.captain_team.application.DemoApplication;
...
import com.xcy.fzb.captain_team.fragment.ComprehensiveFragment;
import com.xcy.fzb.captain_team.fragment.CountryFragment;
import com.xcy.fzb.captain_team.fragment.HouseTypeFragment;
import com.xcy.fzb.captain_team.fragment.PriceFragment;
import com.xcy.fzb.captain_team.fragment.ScreeningFragment;
...
public class OverSeaActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    CountryFragment countryFragment = new CountryFragment(FinalContents.getProjectType());
    ...
    private List<NationBean.DataBean> nationlist = new ArrayList<>();
    private List<ImgData.DataBean> imglist = new ArrayList<>();
    private List<ImgData.DataBean> imagelist = new ArrayList<>();
