package com.xcy.fzb.captain_team.service;

import com.xcy.fzb.captain_team.database.AddClientBean;
import com.xcy.fzb.captain_team.database.AddPhotoBean;
import com.xcy.fzb.captain_team.database.AgentDetailsBean;
import com.xcy.fzb.captain_team.database.AgentListBean;
import com.xcy.fzb.captain_team.database.BorkerageDownBean;
import com.xcy.fzb.captain_team.database.BorkerageUpBean;
import com.xcy.fzb.captain_team.database.BrokerBean;
import com.xcy.fzb.captain_team.database.BrokerSaveBean;
import com.xcy.fzb.captain_team.database.BusinessBean;
import com.xcy.fzb.captain_team.database.ChangePassowrdBean;
import com.xcy.fzb.captain_team.database.ChangePhoneBean;
import com.xcy.fzb.captain_team.database.ChangeSexBean;
import com.xcy.fzb.captain_team.database.CityBean;
import com.xcy.fzb.captain_team.database.ClientBean;
import com.xcy.fzb.captain_team.database.ClientCommissionsBean;
...
import com.xcy.fzb.captain_team.database.DetailsBean;
import com.xcy.fzb.captain_team.database.DictListBean;
import com.xcy.fzb.captain_team.database.DisclaimerBean;
import com.xcy.fzb.captain_team.database.DiscussBean;
import com.xcy.fzb.captain_team.database.DynamicBean;
import com.xcy.fzb.captain_team.database.EconomicCircleBean;
import com.xcy.fzb.captain_team.database.ExemplaryUserBean;
import com.xcy.fzb.captain_team.database.FailureBean;
import com.xcy.fzb.captain_team.database.FeedBackBean;
import com.xcy.fzb.captain_team.database.FinanceBean;
import com.xcy.fzb.captain_team.database.GetLandLineBean;
import com.xcy.fzb.captain_team.database.GetLandLineTimeBean;
import com.xcy.fzb.captain_team.database.GoodNewsBean;
import com.xcy.fzb.captain_team.database.HomeBean;
import com.xcy.fzb.captain_team.database.HomeListBean;
import com.xcy.fzb.captain_team.database.HotBean;
import com.xcy.fzb.captain_team.database.ImgData;
import com.xcy.fzb.captain_team.database.LandSaveBean;
import com.xcy.fzb.captain_team.database.LevelBean;
import com.xcy.fzb.captain_team.database.LikeNumBean;
import com.xcy.fzb.captain_team.database.LoginUserBean;
import com.xcy.fzb.captain_team.database.MessageBean;
import com.xcy.fzb.captain_team.database.MessageBean2;
import com.xcy.fzb.captain_team.database.MoneyCountBean;
import com.xcy.fzb.captain_team.database.MyClientFragmentBean;
import com.xcy.fzb.captain_team.database.MyDataBean;
import com.xcy.fzb.captain_team.database.MyTeamBean;
import com.xcy.fzb.captain_team.database.NickNameBean;
import com.xcy.fzb.captain_team.database.OperationBean;
import com.xcy.fzb.captain_team.database.PersonalPhotoBean;
import com.xcy.fzb.captain_team.database.RatioByOwnerIdBean;
import com.xcy.fzb.captain_team.database.ReceivableBean;
...
import com.xcy.fzb.captain_team.database.UserBean;
import com.xcy.fzb.captain_team.database.UserMessageBean;
...
public interface MyService {
    ...
    Observable<DailyTurnoverBean> getDailyTurnover(@Query("userId") String userId, @Query("state") String state, @Query("type") String type, @Query("startDate") String startDate, @Query("endDate") String endDate);
    ...
    Observable<CommissionListBean> getCommissionList(@Query("userId") String userId, @Query("projectType") String projectType, @Query("search") String search, @Query("status") String status);
    ...
    //团队人员
    @POST("layersSelect/agentList")
    Observable<TeamMemberBean> getTeamMemberBeane(@Query("searcName") String searcName, @Query("type") String type, @Query("loginFlag") String loginFlag, @Query("userId") String userId, @Query("agentId") String agentId);
