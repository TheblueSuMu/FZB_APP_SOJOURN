...
import com.xcy.fzb.captain_team.view.MessageIssueActivity;
...
public class HomeRecyclerAdapter extends RecyclerView.Adapter<HomeRecyclerAdapter.ViewHolder> {
    ...
    private List<HomeListBean.DataBean.RowsBean> beanList;
    ...
    public HomeRecyclerAdapter(List<HomeListBean.DataBean.RowsBean> beanList) {
