...
//TODO 圈层5-2添加顾问
public class AddAConsultantActivity extends AppCompatActivity implements View.OnClickListener, SlideSwitch.SlideListener {

    ImageView add_aconsultant_img;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_aconsultant);
        ...
        userMessage.subscribeOn(Schedulers.io())
                ...
                .subscribe(new Observer<TeamLeaderLevelBean>() {
                    ...
                    public void onNext(final TeamLeaderLevelBean teamLeaderLevelBean) {
                        ...
                        //      监听选中
                        OptionsPickerView pvOptions = new OptionsPickerBuilder(AddAConsultantActivity.this, new OnOptionsSelectListener() {
                            @Override
                            public void onOptionsSelect(int options1, int option2, int options3, View v) {
                                //               返回的分别是三个级别的选中位置
                                //              展示选中数据
                                add_aconsultant_tv2.setText(teamLeaderLevelBean.getData().get(options1).getName()+"");
        ...
        userMessage.subscribeOn(Schedulers.io())
                ...
                .subscribe(new Observer<BrokerSaveBean>() {
                    ...
                    public void onNext(BrokerSaveBean brokerSaveBean) {
                        Toast.makeText(AddAConsultantActivity.this, brokerSaveBean.getData().getMessage(), Toast.LENGTH_SHORT).show();
                        finish();
                    }
